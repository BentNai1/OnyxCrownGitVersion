...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //camera at bottom (default orientation)
        else
        {
            GetInputDownCamera();
        }
